...
CASES = [
    ...
    ("installer-omit-devbox", "scripts/install-devbox", 'helpers="devbox devbox-relink devbox-session devbox-turn devbox-worktree"', 'helpers="devbox-relink devbox-session devbox-turn devbox-worktree"', ["python3", "tests/test-install-devbox-lifecycle.py"], "docker_exact_argv"),
    ("installer-omit-relink", "scripts/install-devbox", 'helpers="devbox devbox-relink devbox-session devbox-turn devbox-worktree"', 'helpers="devbox devbox-session devbox-turn devbox-worktree"', ["python3", "tests/test-install-devbox-lifecycle.py"], "docker_exact_argv"),
    ...
    ("installer-helper-order", "scripts/install-devbox", 'helpers="devbox devbox-relink devbox-session devbox-turn devbox-worktree"', 'helpers="devbox-relink devbox devbox-session devbox-turn devbox-worktree"', ["python3", "tests/test-install-devbox-lifecycle.py"], "docker_exact_argv"),
    ("harness-omit-session-helper", "scripts/devbox-anywhere", 'for helper in ("devbox", "devbox-relink", "devbox-session", "devbox-turn", "devbox-worktree"):', 'for helper in ("devbox", "devbox-relink", "devbox-turn", "devbox-worktree"):', ["python3", "tests/test-agent-harness-operations.py"], "verify_check_ids"),
